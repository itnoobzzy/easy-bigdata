...
var _RegisterRequest_Mobile_Pattern = regexp.MustCompile("^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\\d{8}$")
...
// Validate checks the field values on LoginRpl with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *LoginRpl) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on LoginRpl with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in LoginRplMultiError, or nil
// if none found.
func (m *LoginRpl) ValidateAll() error {
	return m.validate(true)
}

func (m *LoginRpl) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, LoginRplValidationError{
					field:  "User",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return LoginRplValidationError{
				field:  "User",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return LoginRplMultiError(errors)
	}

	return nil
}

// LoginRplMultiError is an error wrapping multiple validation errors returned
// by LoginRpl.ValidateAll() if the designated constraints aren't met.
type LoginRplMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LoginRplMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LoginRplMultiError) AllErrors() []error { return m }

// LoginRplValidationError is the validation error returned by
// LoginRpl.Validate if the designated constraints aren't met.
type LoginRplValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LoginRplValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LoginRplValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e LoginRplValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LoginRplValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LoginRplValidationError) ErrorName() string { return "LoginRplValidationError" }

// Error satisfies the builtin error interface
func (e LoginRplValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = LoginRplValidationError{}
